...
```
Producer Account (Domain 1)         Marketplace Account (Domain 2)      Consumer Project (Domain 2)
┌─────────────────────────┐        ┌──────────────────────────────┐    ┌─────────────────────┐
│ SMUS Domain 1           │        │ SMUS Domain 2                │    │ (same domain as     │
│                         │        │                              │    │  Marketplace)       │
│ Glue Table              │        │ Lambda 1: glue-table-sync    │    │                     │
│ (S3 data)               │──EB───▶│  • Mirrors table             │    │                     │
│                         │  Create│  • Grants LF (grantable)     │    │                     │
│                         │  Table │                              │    │                     │
│ Publish Asset           │        │ Lambda 2: catalog-sync       │    │                     │
│ (curated)               │──EB───▶│  • Syncs business metadata   │    │                     │
│                         │  Asset │  • Pulls DQ results          │    │                     │
│                         │  Added │  • Syncs lineage             │    │                     │
│                         │        │  • Auto-publishes            │    │                     │
│                         │        │                              │    │                     │
│                         │        │ Data Source (manual)          │    │                     │
